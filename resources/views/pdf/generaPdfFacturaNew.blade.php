...
<body>
    ...
    <table id="table_nit_num_fac">
        <thead>
            <tr>
                <td><b> NIT</b></td>
                <td>{{ $archivoXML->cabecera->nitEmisor }}</td>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td><b>FACTURA N°</b></td>
                <td>{{ $archivoXML->cabecera->numeroFactura }}</td>
            </tr>
            <tr>
                <td><b>CÓD. AUTORIZACIÓN</b></td>
                <td style="word-wrap: break-word; padding-right: 45px;">{{ $archivoXML->cabecera->cuf }}</td>
            </tr>
        </tbody>
    </table>
    ...
    <table id="table_datos_factura">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $archivoXML->cabecera->nombreEstudiante }}</td>
            </tr>
        </tbody>
    </table>
    ...
    <table id="table_datos_factura1">
        ...
        <tbody>
            ...
            <tr>
                <td style="text-align: right"><b>Periodo Facturado:</b></td>
                <td>{{ $archivoXML->cabecera->periodoFacturado }}</td>
            </tr>
        </tbody>
    </table>
