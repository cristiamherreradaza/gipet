...
<link href="{{ asset('assets/libs/footable/css/footable.bootstrap.min.css') }}" rel="stylesheet">
<style>
...
<script src="{{ asset('assets/libs/footable/js/footable.min.js') }}"></script>
<script src="{{ asset('dist/js/pages/tables/footable-init.js') }}"></script>
<script>
...
<script>
    ...
    $(function () {
        tabla_asignaturas = $('#demo-foo-row-toggler').DataTable({
            language: {
