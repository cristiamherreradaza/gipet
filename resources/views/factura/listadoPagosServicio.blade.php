                    ...
                    <table id="tabla-pagos" class="table table-bordered table-hover table-striped text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($p->factura->facturado == 'Si')
                                        <span class="text-info">{{ $p->factura->numero }}</span>     
                                    @else
                                        <span class="text-primary">{{ $p->factura->numero_recibo }}</span>     
                                ...
                                <td>{{ $p->fecha }}</td>
                                <td>{{ $p->total }}</td>
                                <td>{{ $p->user->nombres }}</td>
                                <td>
                                    @if ($p->facturado=='Si')
                                        @if ($p->estado == 'Anulado')
                                            <a href="#" class="btn btn-danger text-white" title="Factura Anulada"><i class="fas fa-eye"></i></a>
                                        @else
                                            <a href="{{ url("Factura/muestraFactura/$p->id") }}" class="btn btn-info text-white" title="Muestra Factura"><i class="fas fa-eye"></i></a>
                                        @endif
                                    @else
                                        ...
                                        @if ($p->estado == 'Anulado')
                                            <a href="#" class="btn btn-danger text-white" title="Factura Anulada"><i class="fas fa-eye"></i></a>
                                        @else
                                            <a href="{{ url("Factura/muestraRecibo/$p->id") }}" class="btn btn-primary text-white" title="Muestra Recibo"><i class="fas fa-eye"></i></a>
                                        @endif
