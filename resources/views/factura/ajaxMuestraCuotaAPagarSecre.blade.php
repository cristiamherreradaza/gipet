...
<div class="col-md-3">
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="numero_cuota_pago" id="numero_cuota_pago" value="{{ $siguienteCuota->mensualidad }}&deg; Matricula" readonly />
...
{{-- <div class="col-md-2">
    <div class="form-group">
        ...
        <select name="pago_carrera" id="pago_carrera" class="form-control" required>
