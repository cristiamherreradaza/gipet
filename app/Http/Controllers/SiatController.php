...
class SiatController extends Controller
{
    ...
    protected $header                               = "apikey: TokenApi eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9..sFb6hfFDaXRvNMddtVKyc5JHXuW6DI8Flaab-HXj-qimWO16PGgeu_7xLmyFeF5WXQFHL7mRh6Khsz9Dq5ckSA";
    ...
    public function linkQRVerificacion($cuf, $numero){
        return 'https://siat.impuestos.gob.bo/consulta/QR?nit=178436029&cuf='.$cuf.'&numero='.$numero.'&t=2';
        // return 'https://pilotosiat.impuestos.gob.bo/consulta/QR?nit=178436029&cuf='.$cuf.'&numero='.$numero.'&t=2';
    }
    ...
    public function sincronizarListaProductosServicios(){
        ...
        $wsdl               = $this->FacturacionSincronizacion;
        $codigoAmbiente     = $this->codigoAmbiente;
        $codigoPuntoVenta   = $this->codigoPuntoVenta;
        $codigoSistema      = $this->codigoSistema;
        $codigoSucursal     = $this->codigoSucursal;
    ...
    public function recepcionFactura($arch, $fecEnv, $hasArch){
        $this->verificarConeccion();
        $wsdl                   = $this->ServicioFacturacionComputarizada;
        $codigoAmbiente         = $this->codigoAmbiente;
    ...
    public function consultaPuntoVenta(){
        $this->verificarConeccion();
        $wsdl               = $this->FacturacionOperaciones;
        $codigoAmbiente     = $this->codigoAmbiente;
        $codigoSistema      = $this->codigoSistema;
        $codigoSucursal     = $this->codigoSucursal;
        $cuis               = session('scuis');
